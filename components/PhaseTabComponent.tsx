...
import { PhaseCategorieIngredientsType } from "@/types/phase.type";
import { PhaseData } from "@/types/recipe.type";
import { BookOpen, CircleCheck, Search, Trash2 } from "lucide-react";
...
export const PhaseTab = ({
  ...
  const currentPhaseData = currentRecipeData.find(
    (el) => el.id === currentPhase._id
  );
  return (
    <>
                      ...
                      <div className="flex space-x-2">
                        {currentPhaseData?.ingredients.find(
                          ...
                          <Trash2
                            className="w-6 h-6 p-1 text-orange-500 hover:text-orange-700 hover:bg-orange-50 rounded cursor-pointer"
                            onClick={() => {
                              removeIngredientFromPhase(currentPhase._id, item);
                            }}
                          />
                        ) : (
                          <CircleCheck
