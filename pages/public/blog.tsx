      ...
      <div className="max-w-5xl mx-auto p-6 bg-white rounded-lg">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className="text-gray-700 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
        ...
        <div className="bg-[#4B352A] opacity-80 backdrop-blur-md rounded-xl p-6 border border-[#4B352A]">
          <div className="space-y-4">
            {articles.map((article) => (
              <div
                key={article.id}
                className="flex items-center space-x-4 p-4 border-b border-gray-200 last:border-b-0 hover:bg-gray-50 transition-colors rounded-lg"
              >
        ...
        <div className="bg-white/90 backdrop-blur-md rounded-xl p-6 border border-blue-100">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            turpis molestie, rhoncus est a, mattis tellus. Sed dignissim, metus
            nec fringilla accumsan, risus sem sollicitudin lectus, ut interdum
            tellus elit sed risus. Maecenas eget condimentum velit, ut ornare
            feugiat lectus. Class aptent taciti sociosqu ad litora torquent per
            conubia nostra, per inceptos himenaeos. Praesent auctor purus lectus
            sit rutrum dignissim, ut scelerisque ante pulvinar. Donec ut
            bibendum ex. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur
            vel bibendum ante. Morbi convallis convallis elit et cursus
            faucibus. Aliquam ut elementum tellus.
          </p>
        </div>
